"""
FinanceKit — Free Demo Version (V2.7)
...
with st.sidebar:
    ...
    st.markdown(
        "<div style='font-size:0.75rem;color:#4a4a6c;margin-bottom:0.5rem;'>v2.7 · Your money, your machine.</div>",
        unsafe_allow_html=True,
    )
    st.markdown("---")
    page = st.radio(
    ...
    st.caption("Free demo · FinanceKit v2.7")
