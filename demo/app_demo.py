"""
FinanceKit — Free Demo Version (V2.4)
...
with st.sidebar:
    ...
    st.markdown(
        "<div style='font-size:0.75rem;color:#4a4a6c;margin-bottom:0.5rem;'>v2.4 · Your money, your machine.</div>",
        unsafe_allow_html=True,
    )
    st.markdown("---")
    page = st.radio(
    ...
    st.caption("Free demo · FinanceKit v2.4")
