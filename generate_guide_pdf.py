...
# Module 4
section_header("Module 4: Freelance Dashboard")
body("Track clients, log projects, generate invoices, and monitor your freelance income.")
sub_header("How to Use")
numbered(1, "Navigate to Freelance Dashboard in the sidebar")
numbered(2, "View the Overview tab: total invoiced, paid, outstanding, and active clients")
numbered(3, "Go to Clients & Jobs tab to add a new client with name, project, rate, and status")
numbered(4, "Click Add Client/Job to save")
numbered(5, "Use the status filter to view clients by stage (In Progress, Completed, Invoiced, Paid, etc.)")
numbered(6, "Expand any client to update status, edit notes, or delete")
numbered(7, "Go to the Invoices tab to create invoices with line items and payment terms")
numbered(8, "Download invoice PDFs, mark invoices as Paid/Unpaid, or delete them")
numbered(9, "Check the Income tab for monthly income charts and client profitability breakdown")
numbered(10, "Export all invoices to CSV from the Income tab")
sub_header("Status Options")
body("In Progress > Completed > Invoiced > Paid > On Hold > Cancelled")
sub_header("Tips")
bullet("Data saves automatically to data/freelance_data.json")
bullet("Invoice PDFs include line items, totals, payment terms, and your name")
...
bullet("Portfolio and freelance data persist between sessions automatically.")
